...
MAIL_LASER_WEBHOOK_URL=https://your-api.com/hook
MAIL_LASER_HEADER_PREFIX=X-Custom
RUST_LOG=info`

const tabs = [
  { name: '.env', isActive: true },
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                ...
                <Button href="https://github.com/Govcraft/mail-laser" variant="secondary">
                  View on GitHub
                </Button>
              </div>
            </div>
