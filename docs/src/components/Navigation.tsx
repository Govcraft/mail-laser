      ...
      <ul role="list" className="space-y-9">
        {navigation.map((section) => (
          <li key={section.title}>
            ...
            <ul
              role="list"
              className="mt-2 space-y-2 border-l-2 border-stone-200 lg:mt-4 lg:space-y-4 lg:border-stone-200 dark:border-stone-800"
            >
                ...
                <li key={link.href} className="relative">
                  <Link
                    ...
                    className={clsx(
                      ...
                      link.href === pathname
                        ? 'font-semibold text-amber-600 before:bg-amber-500 dark:text-amber-400 dark:before:bg-amber-400'
